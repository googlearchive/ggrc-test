...
class TestArtyCreate(WebDriverTestCase):
    ...
    def testArtyCreate(self):
        ...
        program_object.program_elements['title']="Program for Load Test"
        ...
        standard_object.standard_elements['title']="Standard"  # Standard for Load Test
        ...
        section_object.section_elements['title']="Section"  # Section for Load Test
        ...
        objective_object.objective_elements['title']="Objective"  # Objective for Load Test
        ...
        control_object.control_elements['title']="Control"  # Control for Load Test
        ...
        do.createObjectIncrementingNaming(section_object, "Section", 25)  #case sensitive parameter & singularity
