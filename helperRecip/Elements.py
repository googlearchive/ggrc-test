...
class Elements(object):
        ...
        section_widget_join_object_link ='//section[contains(@id,"widget")]//a[contains(text(),"OBJECT")]'
        section_widget_expanded_join_link1 = '//section[contains(@id,"widget")]//a[contains(text(),"OBJECT")][@class="section-add"]'
        section_widget_expanded_join_link2 = '//section[contains(@id,"widget")]//span[contains(@class,"section-expander")]//a[contains(text(),"OBJECT")]'
