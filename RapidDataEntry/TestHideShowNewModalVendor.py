...
class TestHideShowNewModalVendor(WebDriverTestCase):

    def testHideShowNewModalVendor(self):
        self.testname="TestHideShowNewModalVendor"
        self.setup()
        ...
        do.openCreateNewObjectWindowFromLhn("Vendor")
 
        # hide_all, show_all, then hide individual
        do.hideInNewModal(list_all, True, "vendor")
        do.hideInNewModal(list_all, False, "vendor")
        ...
        do.hideInNewModal(list_all, False, "vendor")
        do.hideInNewModal(a_few_items, True, "vendor")
        do.hideInNewModal(list_all, False, "vendor")
        
        do.populateNewObjectData(do.generateNameForTheObject("vendor"))
