...
class TestSaveAndAddAnotherPerson(WebDriverTestCase):
    
    
    def testSaveAndAddAnotherPerson(self):
        self.testname="TestSaveAndAddAnotherPerson"
        self.setup()
        ...
        object_1_name = do.generateNameForTheObject("Person")
        ...
        print "Object 1: "
        object_1_link = do.verifyObjectIsCreatedinLHN("Person", object_1_name)
        do.navigateToObjectAndOpenObjectEditWindow("Person",object_1_link)
        do.deleteObject()
        
        print "Object 2: "
        object_2_link = do.verifyObjectIsCreatedinLHN("Person", object_2_name)
        do.navigateToObjectAndOpenObjectEditWindow("Person",object_2_link)
        do.deleteObject()        
